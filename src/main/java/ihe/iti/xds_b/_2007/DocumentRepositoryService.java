 ...
 *
 */
@WebServiceClient(name = "DocumentRepository_Service", targetNamespace = "urn:ihe:iti:xds-b:2007", wsdlLocation = DocumentRepositoryService.REPOSITORY_PATH)
public class DocumentRepositoryService
		extends Service {

	public final static String REPOSITORY_PATH = "RepositoryPS_1.wsdl";
	...
	static {
		...
		DOCUMENTREPOSITORYSERVICE_WSDL_LOCATION = DocumentRepositoryService.class.getResource(REPOSITORY_PATH);
		if (DOCUMENTREPOSITORYSERVICE_WSDL_LOCATION == null) {
			e = new WebServiceException("Cannot find 'repository.wsdl' wsdl. Place the resource correctly in the classpath.");
		}

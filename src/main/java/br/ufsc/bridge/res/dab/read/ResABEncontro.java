package br.ufsc.bridge.res.dab.read;
...
import br.ufsc.bridge.res.dab.read.caracterizacaoconsulta.ResABCaracterizacaoConsulta;
import br.ufsc.bridge.res.dab.read.desfecho.ResABDadosDesfecho;
import br.ufsc.bridge.res.dab.read.medicamento.ResABListaMedicamentos;
import br.ufsc.bridge.res.dab.read.medicoesobservacoes.ResABMedicoesObservacoes;
import br.ufsc.bridge.res.dab.read.problema.ResABProblemaDiagnosticoAvaliado;
import br.ufsc.bridge.res.dab.read.procedimento.ResABProcedimentosPequenasCirurgias;

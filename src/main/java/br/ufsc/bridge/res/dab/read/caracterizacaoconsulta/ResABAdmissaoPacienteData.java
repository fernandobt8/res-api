...
import br.ufsc.bridge.res.dab.read.caracterizacaoconsulta.equipe.ResABIdentificaçãoEquipeSaude;
import br.ufsc.bridge.res.dab.read.caracterizacaoconsulta.horaadmissao.ResABDataHoraAdmissao;
import br.ufsc.bridge.res.dab.read.caracterizacaoconsulta.localizacao.ResABLocalizacaoAtribuidaPaciente;
import br.ufsc.bridge.res.dab.read.caracterizacaoconsulta.profissional.ResABIdentificacaoProfissional;
import br.ufsc.bridge.res.dab.read.caracterizacaoconsulta.tipoatendimento.ResABTipoAtendimento;
import br.ufsc.bridge.res.dab.read.caracterizacaoconsulta.turno.ResABTurnoAtendimento;

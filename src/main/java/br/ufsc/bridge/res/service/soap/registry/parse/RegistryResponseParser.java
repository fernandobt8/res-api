package br.ufsc.bridge.res.service.soap.registry.parse;
...
import br.ufsc.bridge.res.service.soap.exception.ResInvalidRegistryException;
	...
	public static RegistryResponse<RegistryItem> parse(AdhocQueryResponseXPath queryResponse) {
		...
		for (XPathFactoryAssist header : queryResponse.getHeaders()) {
			try {
				...
				registryItem.setDocumentType(TipoDocumento.getByCodigo(queryResponse.getDocumentType(header)));

...
public class ExtrinsicObjectTypeBuilder<T extends ExtrinsicObjectTypeBuilder<T>> {
	...
	public ClassificationTypeBuilder.ClassificationTypeBuilderWrapper<T> buildClassification() {
		return new ClassificationTypeBuilder.ClassificationTypeBuilderWrapper<>((T) this, this.extrinsicObject.getClassification(), this.docId);
	}

	public ExternalIdentifierTypeBuilder.ExternalIdentifierTypeBuilderWrapper<T> buildExternalIdentifier() {
		return new ExternalIdentifierTypeBuilder.ExternalIdentifierTypeBuilderWrapper<>((T) this, this.extrinsicObject.getExternalIdentifier(), this.docId);
	}

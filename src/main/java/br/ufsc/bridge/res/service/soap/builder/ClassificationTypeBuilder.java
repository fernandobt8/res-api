...
public class ClassificationTypeBuilder<T extends ClassificationTypeBuilder<T>> {
	...
	public InternationalStringTypeBuilder.InternationalStringTypeBuilderWrapper<T> buildInternationalString() {
		return new InternationalStringTypeBuilder.InternationalStringTypeBuilderWrapper<>((T) this, this.classificationType);
	}

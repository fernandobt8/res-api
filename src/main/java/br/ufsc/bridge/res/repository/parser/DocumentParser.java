package br.ufsc.bridge.res.repository.parser;
...
public class DocumentParser {
	...
	public void parser(ProvideAndRegisterDocumentSetRequestType provideRegister, RepositoryRegisterDocumentDTO dto) {
		...
		.buildExtrinsicObject()
			...
			.buildSlot()
				.name("creationTime").value(RDateUtil.fromDate(new Date()))
			.addSlotEnd()
			.buildSlot()
				.name("languageCode").value("pt-BR")
			.addSlotEnd()
			.buildSlot()
				.name("serviceStartTime").value(RDateUtil.fromDate(dto.getDataInicioAtendimento()))
			.addSlotEnd()
			.buildSlot()
				.name("serviceStopTime").value(RDateUtil.fromDate(dto.getDataFimAtendimento()))
			.addSlotEnd()
			.buildSlot()
				.name("sourcePatientId").value(dto.getCnsPaciente())
			.addSlotEnd()
			.buildClassification()
				...
				.addSlot()
				    .name("authorInstitution").value(dto.getCnesUnidadeSaude() + "^^^^^&1.2.3.4.5.678&ISO^^^^99")
				.addSlot()
				    .name("authorSpecialty").value(dto.getCboProfissional() + "543797436^^^&1.2.840..113619.6.197&ISO")
				.addSlotEnd()
			...
			.buildClassification()
				...
				.buildSlot()
					.name("codingScheme").value("Connect-a-thon classCodes")
				.addSlotEnd()
			...
			.buildClassification()
				...
				.buildSlot()
					.name("codingScheme").value("Connect-a-thon confidentialityCodes")
				.addSlotEnd()
				.buildInternationalString()
			...
			.buildClassification()
				...
				.buildSlot()
					.name("codingScheme").value("Connect-a-thon formatCodes")
				.addSlotEnd()
				.buildInternationalString()
					.value("tdd")
				.addInternationalStringEnd()
			...
			.buildClassification()
				...
				.buildSlot()
					.name("codingScheme").value("Connect-a-thon healthcareFacilityTypeCodes")
				.addSlotEnd()
				.buildInternationalString()
					.value("Outpatient")
				.addInternationalStringEnd()
			...
			.buildClassification()
				...
				.buildSlot()
					.name("codingScheme").value("Connect-a-thon practiceSettingCodes")
				.addSlotEnd()
				.buildInternationalString()

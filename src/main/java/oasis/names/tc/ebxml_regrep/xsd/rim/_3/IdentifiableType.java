 ...
 * linkage within document and is ignored by the dto. In this case the
 * dto generates a UUID URN for id attribute.
 * id must not be null when object is retrieved from the dto.
 *
 *
...
public class IdentifiableType {
	...
	public List<SlotType1> getSlot() {
		if (this.slot == null) {
			this.slot = new ArrayList<SlotType1>();
		}
		return this.slot;
	}

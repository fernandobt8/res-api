...
import gov.nist.registry.common2.exception.xsd.XdsException;
...
public class Exception {
    ...
    @XmlElementRef(name = "Exception", namespace = "http://serviceclasses.ws.registry.nist.gov", type = JAXBElement.class, required = false)
